...
import PMQ.local.SpringBootProject.modules.users.dtos.resources.SuccessResource;
...
public class UserController {
    ...
    public ResponseEntity<?> me() {
        ...
        SuccessResource<UserResource> response = new SuccessResource<>("Successfully retrieved user information",
                userResource);
